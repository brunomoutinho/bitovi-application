...
import { birthday } from '../codeSnippets/birthday.js';
import { store, storeSolution1 } from '../codeSnippets/store.js';
...
The following code shows an action that could be created to solve this:
